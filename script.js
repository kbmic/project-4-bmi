...
function printBMIResult(BMIInfo){
    ...
    let bmiCategory;
    if(BMIInfo.BMI < 18.5){
        bmiCategory = "You are underweight,need to eat more nutrient !";
    } else if(BMIInfo.BMI >= 18.5 && BMIInfo.BMI <= 24.9){
        bmiCategory = "You have a normal Weight";
    } else if(BMIInfo.BMI >= 25 && BMIInfo.BMI <= 29.9){
        bmiCategory = "You are overweight,need to exercise !";
    } else {
        bmiCategory = "Your health are in danger ,neet to see a doctor asap !";
    }
